/* ===========================================================
   AcademyPro — Profile page
   Simple read-only display of the logged-in student's own record.
   =========================================================== */

(function () {
  const student = initLayout({ activeId: "profile", pageTitle: "Profile", pageIcon: "person" });
  if (!student) return;
